...
│   │       └── lib/                # Shared libraries and AWS wrappers
...
Create a `.env.local` file in the project root. Note that SST uses SNAKE_CASE for environment variables as per their [documentation](https://sst.dev/docs/environment-variables/#secrets):
