---
title: 'Landing Template (Legacy)'
description: 'Legacy template for building a marketing landing page'
---

<Note type="warning">
  **Legacy Template**: This template has been deprecated in favor of the unified [Full-Stack Template](/self-hosting/templates/fs-template). We recommend using the new template for all new projects.
</Note>
