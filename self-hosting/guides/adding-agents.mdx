...
This guide walks you through the process of adding new AI agents to your Agentic Team OS application using the hexagonal architecture pattern from the Full-Stack Template.

## Hexagonal Architecture Overview

The Full-Stack Template uses a hexagonal architecture (also known as ports and adapters) for agent modules. This architecture separates the core business logic from external concerns, making the system more maintainable, testable, and adaptable to change.
