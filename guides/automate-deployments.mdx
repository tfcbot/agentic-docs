...
description: 'Set up automated deployments with SST Console'
---

This guide walks you through setting up automated deployments for your Agentic Team OS applications using [SST Console](https://sst.dev/docs/console/).
